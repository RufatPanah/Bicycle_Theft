...
#_____________________NOW we will perform different features on Random Forest__________________________________
#___________All features
...
hist(treesize(rf_model_01), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_02), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_03), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_04), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_05), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_06), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_07), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_08), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_09), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_10), main = "Number of Nodes for the Trees", col = "green")
...
hist(treesize(rf_model_11), main = "Number of Nodes for the Trees", col = "green")
...
boxplot(class_rf_models)

#__________________________________________TREE model_________________________________________________________
...
#No Premises_Type+Occurrence_DayOfWeek+Occurrence_Date+Occurrence_Month + Occurrence_Hour__________________________
set.seed(999)
data_1<- bt_clean_future_selection
...
tree_model_07 <- train(Hood_Risk ~ Hood_ID + Division + NeighbourhoodName + Location_Type, data = data_1_train, method = "rpart", trControl = ctrl, tuneLength = 50)
...
boxplot(class_accurracy_tree_model)
